...
/*$pageName es el nombre de nuestra plantilla. El nombre del fichero que se pretende mostrar (sin la extensión). Por ejemplo, muestraBaraja $params este array es el contenedor de las variables que deseamos pasar a la vista (la página a mostrar).
